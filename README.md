...
`Rajeshkannanaj`, `Diabetes-prediction`,  `alagurajan9942@gmail.com`
...
1. Clone the repo
```
git clone https://github.com/Rajeshkannanaj/Diabetes-prediction.git
```
...
Your Name - Rajeshkannanaj

Project Link: [https://github.com/Rajeshkannanaj/Diabetes-prediction/](https://github.com/Rajeshkannanaj/Diabetes-prediction/)
